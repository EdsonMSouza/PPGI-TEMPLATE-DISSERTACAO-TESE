...
\begin{quadros}[ht!]
	...
	\begin{small}
		...
		% \begin{tabular}{|l|l|p{14.0cm}|}
		\begin{tabular}{|l|l|}
			\hline
			\textbf{\#} & \textbf{Descrição} \\\hline
			1           & \makecell[l]{linha 1 \\ linha 2 \\ linha 3 - conteúdo conteúdo conteúdo conteúdo conteúdo conteúdo conteúdo conteúdo }   \\\hline
...
Utilize o comando \texttt{$\backslash$observacao\{\}} para destacar uma anotação. Exemplo: \observacao{Seria interessante incluir uma tabela comparativa aqui?}
