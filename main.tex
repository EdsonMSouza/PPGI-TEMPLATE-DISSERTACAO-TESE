\PassOptionsToPackage{abnt-etal-cite=2,abnt-etal-text=emph}{abntex2cite}
...
\Titulacao{Mestre} % Mestre ou Doutor
\Orientador{Dr(a). Nome do(a) Orientador(a)} % Obrigatório
...
% Descomentar as linhas abaixo para incluir a ficha catalográfica e a ficha de aprovação, considerando que os arquivos estejam na mesma pasta do arquivo principal .tex
% Ficha catalográfica
...
% Metodologia
\input{capitulos/cap03_metodologia.tex}

% Análise de Resultados e Discussão
\input{capitulos/cap04_analise_discussao.tex}

% Conclusão
\input{capitulos/cap05_conclusao.tex}

% Trabalhos Futuros
\input{capitulos/cap06_trabalhos_futuros.tex}
